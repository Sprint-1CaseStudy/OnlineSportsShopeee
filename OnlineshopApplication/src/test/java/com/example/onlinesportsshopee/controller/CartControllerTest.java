...
class CartControllerTest {
    ...
    @Test
	   public void testAddCart() throws Exception{
	        ...
	        Mockito.when(icartservice.addCart(productEnt.getId())).thenReturn(cart);
    ...
    @Test
	   public void testDeleteCart() throws Exception{
	        ...
	        //Mockito.when(icartservice.addCart(productEnt.getId())).thenReturn(cart1);
	       // MvcResult mvcResult = this.mockMvc.perform(MockMvcRequestBuilders.delete(URI,151).accept(MediaType.APPLICATION_JSON)).andReturn();
	        //MockHttpServletResponse mockHttpServletResponse = mvcResult.getResponse();
	        //String jsonOutput = mockHttpServletResponse.getContentAsString();
	        //assertThat(jsonInput).isEqualTo(jsonOutput);
	        //Assert.assertNotEquals(HttpStatus.OK.value(), mockHttpServletResponse.getStatus());
